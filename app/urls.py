...
urlpatterns = [
	...
	path("login/forgot_password/reset/", PasswordResetView.as_view(
		template_name='app/user/password_reset.html'), 	name="password-reset"),
	...
	path("login/forgot_password/reset/done/", PasswordResetDoneView.as_view(
		template_name='app/user/password_reset_done.html'), name="password_reset_done"),
	path("login/forgot_password/reset/complete/", PasswordResetCompleteView.as_view(
		template_name='app/user/password_reset_complete.html'), name="password_reset_complete"),
