"""
Django settings for operate project.
...
SECRET_KEY = 'django-insecure-wmhv=6&_hm9(lzo7dyk9-iad9h!6&%vc*a(=t#nbxh0b)ewap7'
...
WSGI_APPLICATION = 'operate.wsgi.application'
